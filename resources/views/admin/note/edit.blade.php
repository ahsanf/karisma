                        ...
                        <form action="" method="post" id="noteForm">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="note_title" value="{{ old('note_tile', $data['note']['note_title']) }}" placeholder="Masukkan Judul Catatan">
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="text  -label">Tanggal</label>
                                    <input type="text" class="form-control" placeholder="Masukkan Tanggal" id="mdate" name="note_date" value="{{ old('event_date', $data['note']['note_date']) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control default-select">
                                    <option value="0" @if($data['note']['status'] == '0') selected @endif>Draft</option>
                                    <option value="1" @if($data['note']['status'] == '1') selected @endif>Published</option>
                                </select>
                            </div>


                    </div>
                    <textarea id="summernoteNote" name="note_content">{{ $data['note']['note_content'] }}</textarea>
                </div>
                <input id="note_id" type="hidden" name="note_id" value="{{ $data['note']['id'] }}">
